async function main() {
    ...
    const ChessGameContractFactory = await ethers.getContractFactory("ChessGame");
    const ChessGameInstance = await ChessGameContractFactory.deploy();
    console.log("ChessGame contract address:", ChessGameInstance.address);
